  ...
  return (
    <Grid container spacing={2}>
      ...
      <Grid item xs={12} sm={12} md={12} lg={6} xl={6}>
        ...
        <Typography>
          {patient.institucion.prevision.nombre} {patient.institucion.nombre}
        </Typography>
      </Grid>
      <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
        ...
        <Grid container>
          ...
          {validContacts?.map((c: Contact) => {
            return (
              <Grid item key={c._id} xs={12} sm={12} md={12} lg={12} xl={12}>
                <Divider />
                <Typography
                  style={{
                    fontWeight: 'lighter',
      ...
      <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
        ...
        <Grid container>
          ...
          {validAddresses?.map((a: Address) => {
            return (
              <Grid item key={a._id} xs={12} sm={12} md={12} lg={12} xl={12}>
                <Divider />
                <Typography
                  style={{
                    fontWeight: 'lighter',
